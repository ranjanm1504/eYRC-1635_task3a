...
class EnhancedDetector(Node):
    def __init__(self):
        ...
        self.fertiliser_position = None  # Changed to British spelling

        # Store last known positions to republish
        self.last_fruit_positions = {}
        self.last_fertiliser_position = None  # Changed to British spelling
    ...
    def publish_stored_tfs(self):
        ...
        # Republish fertiliser with British spelling
    ...
    def detect_fertiliser_aruco(self, image_disp):
        ...
        if ids is not None and len(ids) > 0:
            for i, marker_id in enumerate(ids.flatten()):
                ...
                # Publish TF - British spelling format
